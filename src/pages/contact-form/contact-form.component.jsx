      ...
      <Jumbotron className="contact-jumbotron">
        <Row>
          <Col className="d-flex justify-content-center flex-wrap">
            ...
            <div className="m-2">
              <a href="https://www.youtube.com/channel/UCGqbecbLQ8OYQovCgkrhwsA/featured" target="_blank" rel="noopener noreferrer">
            ...
            <div className="m-2">
              <a href="https://twitter.com/k0z4k777" target="_blank" rel="noopener noreferrer">
            ...
            <div className="m-2">
              <a href="https://www.facebook.com/gustavo.torresdiaz.33/" target="_blank" rel="noopener noreferrer">
